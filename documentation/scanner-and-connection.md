...
- Filters for devices advertising the Nordic UART Service UUID (so community forks with non-standard names are still found). Known name prefix used by HamCore firmware builds for reference: `HamCore-`
