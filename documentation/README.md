# HamCore - Feature Documentation

HamCore is an open-source Flutter client for HamCore LoRa mesh networking devices. This documentation covers every user-facing feature, how to access it, and what it does.
