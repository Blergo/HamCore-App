...
- **Raster Tile Source**: Sets the MAP theme and with that from where to get the map tile data:
  ...
  There will be no account provided by hamcore. You will have to get you own subscription. StadiaMaps offers a [free](https://stadiamaps.com/pricing/) subscription to download up to 200'000 Standart Raster Basemap tiles.
