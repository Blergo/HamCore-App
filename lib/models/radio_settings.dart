...
class RadioSettings {
  ...
  // Regional preset configurations. TX power is intentionally not part of a
  // preset - it's purely a radio-hardware setting (firmware applies a sane
  // per-variant default and min/max), independent of the RF band plan.
  static final List<(String, RadioSettings)> presets = [
    (
      'UK 70cm',
      RadioSettings(
        frequencyMHz: 434.150,
